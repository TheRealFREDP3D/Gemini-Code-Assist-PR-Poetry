# Collection of poems generated by Gemini PR Code Assistant + Tool to recover the poems. 

- A tool that I used to recover the poems from the Pull Requests Conversations.
- A collection of the poems I recovered with the tool.  

---

**Gemini Code Assistant is not generating poetry anymore**

---

Gemini Code Assistant is not writing poetry anymore.  Here rest the ones I collected 
while I was aware of the bot bard's behavior. 
